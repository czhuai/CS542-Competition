...
class Options():
    ...
    def add_optim_options(self):
        ...
        self.parser.add_argument('--train_data_size', type=int, default=4387)
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--answer_maxlength', type=int, default=10, 
    ...
    def initialize_parser(self):
        ...
        # log
        self.parser.add_argument("--log_tensorboard", default=True, type=bool, help="Log training process result in tensorboard.")

        # multi-gpu
        self.parser.add_argument("--is_distributed", default=False, type=bool, help="Whether is using multi-gpu.")
